	...
	styles
	{
 	...
 	layout
 	{
		place { control="frame_title" align=left x=0 y=0 width=max height=80 }
        	place { control="frame_close,frame_minimize" align=left margin-top=5 margin-left=10 spacing=-2 }

		place { control="MenuBar" x=50 y=2 height=26 align=center }

 		// the title bar is missing, so increase the size of the grip
		place { control="frame_captiongrip" margin=2 width=max height=38 }
		
		place { control="friends_search"  width=112 }	
		place { control="FriendPanelSelf,friends_search,FriendsDialogSheet" y=24 align=left margin-left=7 margin-right=7 margin-top=36 margin-bottom=38 width=max height=max dir=down spacing=3 }	
