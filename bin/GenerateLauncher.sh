...
ssmdir=$PWD
output="SteamSkinManager.desktop"
...
function create {
	...
	echo "Icon=$ssmdir/share/steam-skin-manager/icons/icon.png" >> $output
...
chmod +x "$ssmdir/$output"
mv "$ssmdir/$output" "$HOME/.local/share/applications/$output"
